...
describe('hasSpecial', () => {
  it('returns true if enemy has special', () => {
    const enemy: Enemy = {
      id: 'e1', name: 'n1', hp: 10, atk: 1, def: 1, money: 1, exp: 1, special: ['magical'], priority: 0
    }
...
describe('calcHeroDamage', () => {
  const hero: HeroSnapshot = {
    hp: 100, hpMax: 100, atk: 50, def: 20, money: 0, exp: 0, level: 1, keys: {}, items: [], equipment: {}
  }

  it('calculates basic damage', () => {
    const enemy: Enemy = {
      id: 'e1', name: 'n1', hp: 10, atk: 1, def: 10, money: 1, exp: 1, special: [], priority: 0
    }
  ...
  it('calculates damage against magical enemy', () => {
    const enemy: Enemy = {
      id: 'e1', name: 'n1', hp: 10, atk: 1, def: 10, money: 1, exp: 1, special: ['magical'], priority: 0
    }
...
describe('calcEnemyDamage', () => {
  ...
  it('calculates basic damage', () => {
    const enemy: Enemy = {
      id: 'e1', name: 'n1', hp: 10, atk: 30, def: 10, money: 1, exp: 1, special: [], priority: 0
    }
  ...
  it('calculates damage from magical enemy', () => {
    const enemy: Enemy = {
      id: 'e1', name: 'n1', hp: 10, atk: 30, def: 10, money: 1, exp: 1, special: ['magical'], priority: 0
    }
  ...
  it('calculates damage from shielded enemy', () => {
    const enemy: Enemy = {
      id: 'e1', name: 'n1', hp: 10, atk: 30, def: 10, money: 1, exp: 1, special: ['shield'], priority: 0
    }
